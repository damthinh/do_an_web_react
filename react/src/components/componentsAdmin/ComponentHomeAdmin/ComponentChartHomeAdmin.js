...
const consumptionSeriesName = 'Sự tiêu thụ';
...
const series = [
  { name: 'Iphone', key: 'usa', color: '#08abbd' },
  { name: 'Sony', key: 'saudiArabia', color: '#78bc97' },
  { name: 'Huawei', key: 'iran', color: '#d4d67e' },
  { name: 'Sam Sung', key: 'mexico', color: '#9ccc65' },
  { name: 'Xiao Mi', key: 'russia', color: '#1698af' },
  {
    name: consumptionSeriesName, key: 'consumption', color: consumptionColor, type: AreaSeries,
  },
  {
    name: 'Doanh thu', key: 'price', color: priceColor, scale: 'price', type: SplineSeries,
  },
];
